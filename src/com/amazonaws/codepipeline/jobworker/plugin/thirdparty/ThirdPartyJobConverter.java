...
/**
 * Converts between the Third Party Job data structures and internal job worker structures.
 */
public class ThirdPartyJobConverter {
     ...
     * @return action type (internal model)
     */
